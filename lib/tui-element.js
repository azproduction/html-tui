import {getNormalizedClientRectOf, mergeBoxes, shiftBox, compressBox} from './utils';
...
export default class TuiElement {
     ...
     */
    toOptimizedArray() {
        return compressBox(this.toArray());
    }
    ...
    toString(type = 'default') {
        return boxRenderFactory(type)(this.toOptimizedArray());
    }
}
